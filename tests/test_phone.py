...
def test_normalize_ua_local():
    assert normalize_phone("0671234567") == "+380XXXXXXXXX"


def test_normalize_ua_international():
    assert normalize_phone("+380 67 123 45 67") == "+380XXXXXXXXX"


def test_normalize_ua_with_parens():
    assert normalize_phone("(067) 123-45-67") == "+380XXXXXXXXX"
...
def test_is_ukrainian():
    assert is_ukrainian("+380XXXXXXXXX")
